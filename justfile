...
comet-app-network:
    . ./feasibility/scripts/rust_env.ps1; $env:CARGO_TARGET_DIR=[IO.Path]::GetFullPath('./feasibility/target'); cargo build -p bit-app --example comet_network_probe --locked; py -B feasibility/scripts/run_bit_app_network.py
